...
class Media {
  ...
  createShader() {
    ...
    img.src = this.image || 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=800&auto=format&fit=crop';
    img.onload = () => {
      texture.image = img;
    ...
    img.onerror = () => {
      ...
      if (img.src !== 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=800&auto=format&fit=crop') {
