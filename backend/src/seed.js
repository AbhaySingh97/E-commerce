...
const templates = [
  ...
  { name: 'Leica M11 Camera', sub: 'Cameras', parent: 'Electronics', img: '1551024506-0db9fc19366e', price: 795000 },
  { name: 'Hermès Silk Scarf', sub: 'Accessories', parent: 'Fashion', img: '1583121274606-3e0497746a82', price: 42000 },
  { name: 'Rolex Submariner', sub: 'Wearables', parent: 'Electronics', img: '1584030373083-58678399715b', price: 950000 },
  { name: 'Bang & Olufsen A9', sub: 'Audio', parent: 'Electronics', img: '1545453330-c1f713247412', price: 295000 },
  ...
  { name: 'Dyson V15 Detect', sub: 'Smart Home', parent: 'Electronics', img: '1584622650111-993a426fbf0a', price: 75000 },
...
async function seedDatabase() {
  try {
    ...
    const productsToInsert = templates.map((t, i) => ({
      ...
      stock: 50,
      images: [`https://images.unsplash.com/photo-${t.img}?auto=format&fit=crop&q=80`],
      attributes: { quality: 'Premium' }
    }));

    // Variations with unique images where possible
    const variations = [
        { name: 'Leica M11 (Black Paint)', img: '1551024506-0db9fc19366e', price: 825000, sub: 'Cameras' },
        { name: 'Rolex Cosmograph Daytona', img: '1614165939026-3d72dc40b1b7', price: 2450000, sub: 'Wearables' },
        { name: 'Hermès Birkin 30', img: '1598533168479-55527f8cc13e', price: 1850000, sub: 'Bags' },
        { name: 'B&O Beolab 90', img: '1511379938547-c1f69419868d', price: 9500000, sub: 'Audio' }
    ];
    ...
    variations.forEach((v, i) => {
        productsToInsert.push({
            ...
            stock: 5,
            images: [`https://images.unsplash.com/photo-${v.img}?auto=format&fit=crop&q=80`],
